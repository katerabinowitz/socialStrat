...
icons <- rbind(iconsLoSub, iconsHi) %>%
         mutate(income = factor(income, levels = c("inc025", "inc2550", "inc5075", "inc75100", "inc100125", "inc125150", "inc150175","inc175200", "inc200225", 
                                                   "inc225250", "inc250275", "inc275300", "inc300325", "inc325350", "inc350375", "inc375400", "inc400+")),
                #ugh
